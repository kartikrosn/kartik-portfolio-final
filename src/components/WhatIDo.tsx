          ...
          >
            ...
            <div className="what-content-in">
              ...
              <ul style={{ textAlign: "left", paddingLeft: "15px", listStyleType: "disc", color: "#ccc", margin: "8px 0", fontSize: "13px", lineHeight: "1.4", display: "flex", flexDirection: "column", gap: "6px" }}>
                ...
                <li>Analyze logs from multiple sources (network, endpoints, servers) to detect anomalies and malicious behavior.</li>
              </ul>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <ul style={{ textAlign: "left", paddingLeft: "15px", listStyleType: "disc", color: "#ccc", margin: "8px 0", fontSize: "13px", lineHeight: "1.4", display: "flex", flexDirection: "column", gap: "6px" }}>
                ...
                <li>Collaborate with teams to improve detection rules, security monitoring, and response efficiency.</li>
              </ul>
              <div className="what-arrow"></div>
            </div>
          </div>
